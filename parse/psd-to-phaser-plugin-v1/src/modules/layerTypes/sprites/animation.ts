...
export function placeAnimation(
  ...
  if (sprite.frame_width && sprite.frame_height) {
    ...
    if (sprite.yoyo !== undefined) animConfig.yoyo = sprite.yoyo;
    if (sprite.repeatDelay !== undefined) animConfig.repeatDelay = sprite.repeatDelay;
    if (sprite.duration !== undefined) animConfig.duration = sprite.duration;
